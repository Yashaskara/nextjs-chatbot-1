import { ProductViewButtons, Products } from "@unbxd-ui/react-search-components";
...
<Callout type="warning">
	<div>**Note:**</div>
	<div>
		The **ProductViewButtons** component must be used within the wrapper (in CSR, SSR and Custom Hooks approaches) to ensure that the component and the search
...
The component that will be rendered for each button. <br></br>
Example component:
