...
<Callout type="info" emoji="ℹ️" >
	<div>**Note:**</div>
	<div>
		The **LoadMorePagination** component must wrap around the **Products** component.
		For an example of how this component should be rendered, refer to the code in the **Live Demo** section.
		This setup ensures that the pre-loader is correctly positioned, enabling efficient and smooth functionality.
	</div>
</Callout>
