    ...
    const messages = [
      {
        role: 'system',
        content:
          'You are a helpful assistant that answers questions based solely on the provided documentation excerpts. Do not include information not in the excerpts. If unsure, say you do not know.',
      },
      {
        role: 'user',
